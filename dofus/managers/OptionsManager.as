...
_loc1.applyOption = function(_loc2_, _loc3_)
{
   switch(_loc2_)
   {
      ...
      case "ElectronEnableChatDarkMode":
         _root.api._oElectron.setChatDarkMode(_loc3_);
         break;
      case "MovableBar":
