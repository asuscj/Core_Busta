...
_loc1.onActionsStart = function(sExtraData)
{
   ...
   if(_loc3_ == this.api.datacenter.Player.ID && this.api.datacenter.Game.isFight)
   {
...
_loc1.alternativeGameAction = function(_loc2_)
{
   ...
   {
      _loc9_.addAction(117,false,_loc7_,_loc7_.ack,[_loc8_]);
   }
   else
   {
...
_loc1.onActions = function(_loc2_)
{
   ...
   switch(_loc6_)
   {
      ...
      case 51:
         ...
         _loc32_ = new ank.battlefield.datacenter["\x1e\n\x01"]();
      ...
      case 110:
         ...
         _loc201_ = _loc53_[0];
         _loc29_ = this.api.datacenter.Sprites.getItemAt(_loc201_);
         _loc30_ = Number(_loc53_[1]);
         if(_loc30_ != 0)
         {
            _loc211_ = Number(_loc53_[2]);
            _loc80_ = dofus.Constants.getElementColorById(_loc211_);
            _loc78_ = _loc30_ < 0 ? "LOST_LP" : "WIN_LP";
            if(_loc80_ != undefined && this.api.kernel.OptionsManager.getOption("SeeDamagesColor"))
            {
               _loc85_ = this.api.lang.getText(_loc78_,[_loc29_.name,"<font color=\"#" + _loc80_ + "\">" + Math.abs(_loc30_) + "</font>"]);
            }
            else
            {
      ...
      case 103:
         _loc19_ = _loc5_;
         _loc10_ = this.api.datacenter.Sprites.getItemAt(_loc19_);
         _loc24_ = _loc10_.mc;
         ...
         if(_loc4_ == this.api.datacenter.Player.ID)
         {
            ...
            _loc184_ = this.api.datacenter.Sprites.getItemAt(_global.parseInt(_loc19_)).Team;
      ...
      case 132:
         ...
         _loc25_ = this.api.datacenter.Sprites.getItemAt(_loc5_);
      ...
      case 181:
         ...
         {
            this.api.datacenter.Player.SummonedCreatures++;
            this.api.datacenter.Player.summonedCreaturesID[_loc113_] = true;
         }
      ...
      case 149:
         ...
         _loc115_ = new dofus.datacenter["\x0f\r"](undefined,_loc6_,_loc147_,_loc140_,undefined,undefined,_loc220_);
      ...
      case 208:
         ...
         _loc23_ = new ank.battlefield.datacenter["\x1e\n\x01"]();
      ...
      case 300:
         ...
         _loc28_ = new ank.battlefield.datacenter["\x1e\n\x01"]();
         ...
         if(_loc4_ == this.api.datacenter.Player.ID)
         {
            ...
            _loc156_ = new dofus.datacenter["\x0b\x18"](_loc56_,_loc196_);
      ...
      case 303:
         ...
         _loc22_ = this.api.datacenter.Sprites.getItemAt(_loc4_);
         _loc237_ = _loc22_.mc;
         _loc66_ = _loc22_.ToolAnimation;
         ...
         _loc206_ = _loc22_.accessories[0].unicID;
         _loc198_ = _loc22_.Guild;
      ...
      case 306:
         ...
         _loc152_ = Number(_loc20_[0]);
         _loc167_ = Number(_loc20_[1]);
         _loc163_ = _loc20_[2];
         _loc129_ = Number(_loc20_[3]);
         _loc120_ = _loc20_[4] == "1" ? true : false;
         _loc86_ = Number(_loc20_[5]);
      ...
      case 307:
         ...
         _loc233_ = new dofus.datacenter["\x1e\x0e\x1c"](_loc158_,_loc168_);
      ...
      case 950:
         ...
         break;
      case 940:
         // Server sometimes sends GA;940 (via GestorSalida.ENVIAR_GA_DEBUG_ACCIONES)
         // to request clearing/debug info. In some clients this ended up
         // enabling a debug UI when reconnecting/changing character.
         // Ignore it here to avoid unsolicited debug activation from the server.
         break;
      ...
      case 998:
         ...
         _loc176_ = _loc18_[6];
         _loc170_ = _loc18_[7];
         _loc193_ = new dofus.datacenter["\x0f\r"](undefined,Number(_loc209_),Number(_loc200_),Number(_loc224_),Number(_loc219_),"",Number(_loc176_),Number(_loc170_));
