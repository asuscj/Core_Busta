...
_loc1.gananciasOgrinasReto = 0;
_loc1.cambiarGananciasReto = function(ogrinas)
{
   this.gananciasOgrinasReto = ogrinas;
};
_loc1.onFightChallenge = function(_loc2_)
{
   ...
   if(_loc6_ == "+")
   {
      _loc5_ = _global.parseInt(_loc3_[0]);
      // Expecting 9 fields now (state appended as index 8). Older packets had only 8.
      _loc4_ = new dofus.datacenter["\x0e\x0f"](_loc5_,_global.parseInt(_loc3_[1]),_loc3_[2] == "1",_global.parseInt(_loc3_[3]),_global.parseInt(_loc3_[4]),_global.parseInt(_loc3_[5]),_global.parseInt(_loc3_[6]),_global.parseInt(_loc3_[7]));
      if(_loc3_.length > 8)
      {
         // Initialize state directly from server instead of waiting for GdaK/GdaO
         _loc4_.state = _global.parseInt(_loc3_[8]);
      }
      else
      {
         _loc4_.state = 0; // fallback
      }
      _loc7_ = this.api.ui.getUIComponent("FightChallenge").challenges.findFirstItem("unicID",_loc5_);
      if(_loc7_.index != -1)
      {
         this.api.ui.getUIComponent("FightChallenge").challenges.updateItem(_loc7_.index,_loc4_);
         this.api.ui.getUIComponent("FightChallenge").updateList();
      }
      else
      {
...
_loc1.setBoostsStats = function(_loc2_)
{
   ...
   var _loc5_ = Number(_loc7_[0]);
   var _loc6_ = Number(_loc7_[1]);
   var _loc3_ = _loc7_[2];
   var _loc4_ = _loc7_[3];
...
_loc1.onStartToPlay = function()
{
   ...
   _loc3_.showGiveUpButton(true);
   _loc3_._cChat.mostrarBotones(false);
   var _loc5_;
   if(!this.api.datacenter.Game.isSpectator)
   {
      ...
      _loc5_.initMP();
      _loc5_.initLP();
      _loc3_.showPoints(true);
      _loc3_.showNextTurnButton(true);
      ...
      _loc3_.shortcuts.setCurrentTab("Spells");
   }
   ...
   {
      this.api.gfx.addSpriteExtraClip(_loc4_,dofus.Constants.CIRCLE_FILE,dofus.Constants.TEAMS_COLOR[_loc2_[_loc4_].Team]);
   }
...
_loc1.onMovement = function(sExtraData, bIsSummoned)
{
   ...
   var _loc82_;
   var _loc83_;
   for(; _loc55_ < _loc88_.length; _loc55_ = _loc55_ + 1)
   {
      _loc46_ = _loc88_[_loc55_];
      if(_loc46_.length != 0)
      {
         _loc56_ = false;
         _loc37_ = false;
         ...
         if(_loc37_)
         {
            ...
            _loc24_ = _loc3_[0];
            _loc27_ = _loc3_[1];
            _loc58_ = _loc3_[2].split("^");
            _loc73_ = Number(_loc58_[0]);
            _loc86_ = _loc58_[1] == "1";
            _loc79_ = _loc58_[2];
            _loc8_ = _loc3_[3];
            _loc62_ = _loc3_[4].split("^");
            _loc16_ = _loc62_[0];
            _loc67_ = _loc62_[1];
            _loc81_ = _loc3_[5];
            _loc18_ = _loc3_[6];
            ...
            _loc42_ = _loc18_.split("^");
            _loc23_ = _loc42_.length != 2 ? _loc18_ : _loc42_[0];
            _loc72_ = _loc81_.split(",");
            _loc20_ = _loc72_[0];
            _loc64_ = _loc72_[1];
            if(_loc64_.length)
            {
               ...
               if(_loc48_[0].length > 0)
               {
                  ...
                  _loc80_ = new _global.palmad.dofus.datacenter.Title(_global.parseInt(_loc69_[0]),undefined,"",undefined,_loc69_[1]);
               }
               if(_loc48_[1].length > 0)
               {
                  _loc65_ = _loc48_[1].split("*");
                  _loc84_ = new _global.palmad.dofus.datacenter.Title(0,_loc65_[1],_loc65_[0],1,"");
               }
            }
            _loc21_ = 100;
            _loc22_ = 100;
            ...
            switch(_loc20_)
            {
               ...
               case "-2":
                  ...
                  if(_loc20_ == -1)
                  {
                     _loc11_ = this.api.kernel.CharactersManager.createCreature(_loc8_,_loc16_,_loc7_);
                     _loc11_.isClear = false;
                     break;
                  }
                  _loc11_ = this.api.kernel.CharactersManager.createMonster(_loc8_,_loc16_,_loc7_);
                  _loc11_.isClear = false;
                  break;
               case "-3":
                  _loc5_ = new Object();
                  _loc5_.spriteType = _loc20_;
                  ...
                  _loc15_ = _loc3_[9].split(",");
                  _loc5_.color1 = _loc15_[0];
                  _loc5_.color2 = _loc15_[1];
                  _loc5_.color3 = _loc15_[2];
                  _loc5_.extraClip = _loc15_[3];
                  _loc5_.accessories = _loc3_[10];
                  _loc5_.bonusValue = _loc73_;
                  _loc60_ = this.sliptGfxData(_loc18_);
                  _loc33_ = _loc60_.gfx;
                  this.splitGfxForScale(_loc33_[0],_loc5_);
                  _loc11_ = this.api.kernel.CharactersManager.createMonsterGroup(_loc8_,_loc16_,_loc5_);
                  _loc11_.isClear = false;
                  if(this.api.kernel.OptionsManager.getOption("ViewAllMonsterInGroup") == true)
                  {
                     ...
                     while(_loc9_ < _loc33_.length)
                     {
                        if(_loc33_[_loc9_] != "")
                        {
                           ...
                           _loc15_ = _loc3_[9 + 2 * _loc9_].split(",");
                           _loc5_.color1 = _loc15_[0];
                           _loc5_.color2 = _loc15_[1];
                           _loc5_.color3 = _loc15_[2];
               ...
               case "-4":
                  ...
                  _loc11_ = this.api.kernel.CharactersManager.createNonPlayableCharacter(_loc8_,Number(_loc16_),_loc14_);
                  break;
               case "-5":
                  _loc12_ = new Object();
                  _loc12_.spriteType = _loc20_;
                  ...
                  _loc11_ = this.api.kernel.CharactersManager.createOfflineCharacter(_loc8_,_loc16_,_loc12_);
                  break;
               case "-6":
                  _loc10_ = new Object();
                  _loc10_.spriteType = _loc20_;
                  ...
                  _loc11_ = this.api.kernel.CharactersManager.createTaxCollector(_loc8_,_loc16_,_loc10_);
                  break;
               case "-7":
               case "-8":
                  _loc6_ = new Object();
                  _loc6_.spriteType = _loc20_;
               ...
               case "-9":
                  ...
                  _loc11_ = this.api.kernel.CharactersManager.createParkMount(_loc8_,_loc16_ == "" ? this.api.lang.getText("NO_NAME") : _loc16_,_loc25_);
                  break;
               case "-10":
                  _loc26_ = new Object();
                  _loc26_.spriteType = _loc20_;
                  ...
                  _loc11_ = this.api.kernel.CharactersManager.createPrism(_loc8_,_loc16_,_loc26_);
                  break;
               default:
                  _loc4_ = new Object();
                  _loc4_.spriteType = _loc20_;
                  _loc4_.cell = _loc24_;
                  ...
                  _loc4_.esAbonado = _loc86_;
                  _loc4_.colorVIP = _loc79_;
                  if(this.api.datacenter.Game.isFight)
                  {
                  ...
                  if(_loc56_)
                  {
                     _loc87_ = [_loc8_,this.createTransitionEffect(),_loc24_,10];
                  }
                  ...
                  if(_loc36_.length > 3 && _loc8_ != this.api.datacenter.Player.ID)
                  {
                     if(this.api.lang.getAlignmentCanViewPvpGain(this.api.datacenter.Player.alignment.index,Number(_loc4_.alignment.index)))
                     {
                        ...
                        _loc85_ = Number(- _global.RANGO_NIVEL_PVP);
                        _loc59_ = 0;
                        if(this.api.datacenter.Player.Level - _loc77_ > _loc78_)
                        {
                           _loc59_ = -1;
                        }
                        if(this.api.datacenter.Player.Level - _loc77_ < _loc85_)
                        {
                           _loc59_ = 1;
                        }
                        _loc4_.pvpGain = _loc59_;
                     }
                  }
                  ...
                  _loc45_ = this.sliptGfxData(_loc18_);
                  _loc34_ = _loc45_.gfx;
                  this.splitGfxForScale(_loc34_[0],_loc4_);
                  _loc4_.title = _loc80_;
                  _loc4_.title2 = _loc84_;
                  _loc11_ = this.api.kernel.CharactersManager.createCharacter(_loc8_,_loc16_,_loc4_);
                  _loc11_.isClear = false;
                  ...
                  while(true)
                  {
                     ...
                     _loc28_ = _loc8_ + "_" + _loc17_;
                     _loc19_ = new Object();
                     this.splitGfxForScale(_loc34_[_loc17_],_loc19_);
                     _loc29_ = new ank.battlefield.datacenter["\x1e\x0e\x10"](_loc28_,ank.battlefield.mc["\x1e\x0e\x10"],dofus.Constants.CLIPS_PERSOS_PATH + _loc19_.gfxID + ".swf");
                     _loc29_.allDirections = false;
                     this.api.gfx.addLinkedSprite(_loc28_,_loc53_,_loc35_,_loc29_);
                     if(!_global.isNaN(_loc19_.scaleX))
                     {
                        this.api.gfx.setSpriteScale(_loc29_.id,_loc19_.scaleX,_loc19_.scaleY);
                     }
            ...
            this.onSpriteMovement(_loc37_,_loc11_,_loc87_);
         }
         else
         {
            _loc82_ = _loc46_.substr(1);
...
_loc1.onSpriteMovement = function(_loc2_, oSprite, _loc4_)
{
   ...
   if(_loc2_)
   {
      ...
      if(oSprite.mc != undefined)
      {
         oSprite.mc.draw();
         if(oSprite.mc._visible == false || oSprite.mc._visible == undefined)
         {
            oSprite.mc._visible = true;
         }
      }
      ...
      if(oSprite instanceof dofus.datacenter["\x13\x01"])
      {
         if(oSprite.esAbonado)
         {
            this.api.gfx.addEstiloAbonado(oSprite.id);
         }
      }
      if(oSprite instanceof dofus.datacenter["\n\x01"])
      {
         if(oSprite.colorVIP != "")
         {
...
_loc1.onEnd = function(_loc2_)
{
   ...
   var _loc3_ = {winners:[],loosers:[],collectors:[],challenges:_loc6_.challenges.clone(),currentTableTurn:this.api.datacenter.Game.currentTableTurn,currentPlayerInfos:[]};
   ...
   {
      _loc8_ = _loc4_[0].split(";");
      _loc3_.duration = Number(_loc8_[0]);
   ...
   var _loc11_ = 0;
   this.parsePlayerData(_loc3_,3,_loc10_,_loc4_,_loc5_,_loc11_,_loc9_);
};
_loc1.parsePlayerData = function(resultsObject, index, fightInitiatorID, rawArray, fightType, sharedKamas, sharedLootArray, bAlreadyParsed, bIsChest)
{
   var currentIndex = index;
   var dataParts = rawArray[currentIndex].split(";");
   ...
   if(Number(dataParts[0]) != 6)
   {
      ...
      nameData = this.api.kernel.CharactersManager.getNameFromData(dataParts[2]);
      playerData.name = nameData.name;
      playerData.type = nameData.type;
      playerData.gfx = nameData.gfx;
      playerData.level = Number(dataParts[3]);
      playerData.bDead = dataParts[4] == "1" ? true : false;
      switch(Number(dataParts[0]))
      {
         case 1:
            ...
            playerData.maxdisgrace = this.api.lang.getMaxDisgracePoints();
            playerData.mindisgrace = 0;
            itemsStr = dataParts[12].split(",");
            if(playerData.id == this.api.datacenter.Player.ID && itemsStr.length > 10)
            {
   ...
   {
      itemsStr = dataParts[1].split(",");
      playerData.kama = Number(dataParts[2]);
      sharedKamas += Number(playerData.kama);
   }
   playerData.items = this.parseItems(itemsStr);
   switch(Number(dataParts[0]))
   {
      case 0:
      ...
      case 5:
         ...
         break;
      case 6:
         sharedLootArray = sharedLootArray.concat(playerData.items);
   }
   ...
   currentIndex += 1;
   if(currentIndex < rawArray.length)
   {
      this.addToQueue({object:this,method:this.parsePlayerData,params:[resultsObject,currentIndex,fightInitiatorID,rawArray,fightType,sharedKamas,sharedLootArray,bAlreadyParsed,bIsChest]});
   }
   else
   {
      this.onParseItemEnd(fightInitiatorID,resultsObject,sharedLootArray,sharedKamas);
   }
};
...
_loc1.onParseItemEnd = function(fightInitiatorID, resultsObject, sharedLootArray, sharedKamas)
{
   ...
   {
      playerSequencer._bPlaying = false;
