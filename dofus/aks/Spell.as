...
_loc1.onSpellCooldown = function(_loc2_)
{
   ...
   var _loc7_ = this.api.datacenter.Player.Spells.findFirstItem("ID",_loc8_).item;
   var _loc3_;
   var _loc4_;
   if(_loc7_ != undefined)
   {
...
_loc1.boost = function(_loc2_)
{
   this.aks.send("SB" + _loc2_);
};
_loc1.downgrade = function(_loc2_)
{
   this.aks.send("Aps" + _loc2_);
};
#endinitclip