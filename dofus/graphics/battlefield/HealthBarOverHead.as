...
_loc1.drawClip = function(_loc2_, nCurrentValue, nMinValue, _loc5_, nBarWidth, _loc7_, _loc8_, _loc9_)
{
   ...
   // Guardar el valor de vida máxima antes de sobrescribirlo
   var nLifeMaxValue = _loc5_;
   ...
   // Usar nLifeMaxValue guardado, no _loc5_ que ahora es altura del fondo
   this.attachMovie("SpriteHealthBar","_mcSpriteHealthBar",100,{realWidth:nBarWidth,_x:(- nBarWidth) / 2,_y:16 + _global.palmad.dofus.graphics.battlefield.AbstractTextOverHead.HEIGHT_SPACER,lifeCurrentValue:nCurrentValue,lifeMinValue:nMinValue,lifeMaxValue:nLifeMaxValue});
   if(_loc6_)
   {
