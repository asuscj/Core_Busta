...
_loc1.__set__Anio = function(nValue)
{
   this._nAnio = Number(nValue);
};
...
_loc1.addListeners = function()
{
   ...
   this._btnRecibirAlmanax.addEventListener("click",this);
};
...
_loc1.initTexts = function()
{
   ...
   this._btnRecibirAlmanax.label = this.api.lang.getText("RECIBIR_PREMIO");
   this._txtDia.text = this._nDia;
   var _loc9_ = ["Javián","Flovor","Martalo","Aperirel","Maisial","Juninsidor","Juliero","Agusto","Septango","Octobrero","Novimiembro","Desiembro"];
   this._txtMes.text = _loc9_[this._nMes];
   this._txtAnio.text = this._nAnio;
...
,_loc1.__set__Mes);
_loc1.addProperty("anio",function()
{
}
,_loc1.__set__Anio);
