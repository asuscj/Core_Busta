...
_loc1.initData = function()
{
   ...
   this._mcTabViewer._btnElectronEnableChatDarkMode.selected = _loc3_.getOption("ElectronEnableChatDarkMode");
...
_loc1.click = function(_loc2_)
{
   switch(_loc2_.target._name)
   {
      ...
      case "_btnElectronEnableChatDarkMode":
         this.api.kernel.OptionsManager.setOption("ElectronEnableChatDarkMode",_loc2_.target.selected);
         break;
      case "_btnFollower":
...
_loc1.optionChanged = function(_loc2_)
{
   ...
   switch(_loc2_.key)
   {
      ...
      case "ElectronEnableChatDarkMode":
         this._mcTabViewer._btnElectronEnableChatDarkMode.selected = _loc2_.value;
         break;
      case "SpriteInfos":
         break;
      case "tactico":
