...
_loc1.loadMonsters = function(sFilter)
{
   ...
   {
      _loc5_ = _loc12_[_loc22_];
      _loc7_ = _loc5_.b;
      _loc6_ = _loc13_[_loc7_];
      if(_loc6_ == undefined)
      {
      ...
      _loc9_ = {iconFile:_loc21_ + _loc8_ + ".swf",name:_loc11_,id:_loc10_,gfxId:_loc8_,lvls:_loc2_};
      _loc20_.push(_loc9_);
   ...
   switch(oEvent.target._name)
   {
      ...
      case "_btnOk":
         ...
         else
         {
            ...
            _loc8_ = _loc8_ + " " + _loc4_ + " " + _loc7_ + " " + this._txtCondiciones.text + " " + this._txtCondiciones.text + " " + this._txtSegundos.text + " " + this._txtDescripcion.text.split(" ").join("—");
