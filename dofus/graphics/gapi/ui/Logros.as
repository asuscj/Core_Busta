...
_loc1.initData = function()
{
   ...
   _loc11_.push({id:0,label:this.api.lang.getText("PROGRESS_SUCCESS")});
   _loc11_.push({id:1,label:this.api.lang.getText("LCATEGORIA_1")});
   _loc11_.push({id:2,label:this.api.lang.getText("LCATEGORIA_2")});
   _loc11_.push({id:3,label:this.api.lang.getText("LCATEGORIA_3")});
   _loc11_.push({id:4,label:this.api.lang.getText("LCATEGORIA_4")});
   _loc11_.push({id:5,label:this.api.lang.getText("LCATEGORIA_5")});
   _loc11_.push({id:6,label:this.api.lang.getText("LCATEGORIA_6")});
   _loc11_.push({id:7,label:this.api.lang.getText("LCATEGORIA_7")});
   _loc11_.push({id:8,label:this.api.lang.getText("LCATEGORIA_8")});
   _loc11_.push({id:9,label:this.api.lang.getText("LCATEGORIA_9")});
   _loc11_.push({id:10,label:this.api.lang.getText("LCATEGORIA_10")});
   _loc11_.push({id:11,label:this.api.lang.getText("LCATEGORIA_11")});
   _loc11_.push({id:12,label:this.api.lang.getText("LCATEGORIA_12")});
   _loc11_.push({id:13,label:this.api.lang.getText("LCATEGORIA_13")});
   _loc11_.push({id:14,label:this.api.lang.getText("LCATEGORIA_14")});
   _loc11_.push({id:15,label:this.api.lang.getText("LCATEGORIA_15")});
   ...
   while(true)
   {
      ...
      else
      {
         ...
         _loc12_ = Number(_loc6_[_loc4_]) == 0 ? 0 : _global.parseInt(Number(_loc5_[_loc4_]) * 100 / Number(_loc6_[_loc4_]));
         this["_txt" + _loc4_].text = _loc12_ + "%";
      }
   }
...
{
   this.gapi.loadUIComponent("LogroDetalle","LogroDetalle",{id:sData});
};
