...
_loc1.cargaTodo = function(contenido, elvalxx)
{
   ...
   while(_loc3_ < 8)
   {
      _loc2_ = _loc4_[_loc3_].split(";")[0];
      if(_loc2_ == "info")
      {
         break;
      }
      _loc10_ = _loc4_[_loc3_].split(";")[1];
      _loc7_ = _loc4_[_loc3_].split(";")[5];
      this["item" + _loc2_] = _loc7_;
      if(_loc10_ == "item")
      {
         _loc11_ = new ank["\x1e\n\x07"]["\x0f\x01"]();
         _loc5_ = _loc4_[_loc3_].split(";")[7];
         _loc14_ = _loc5_.split("^").join(",");
         _loc13_ = new dofus.datacenter["\f\f"](_loc7_,_loc7_,1,-1,_loc14_);
      ...
      {
         _loc12_ = new dofus.datacenter["\x1e\x0f\x02"](_loc7_,1);
      ...
      _loc15_ = _loc4_[_loc3_].split(";")[3];
      this["precio" + _loc2_].text = _loc15_;
      _loc16_ = _loc4_[_loc3_].split(";")[7];
      this["qua" + _loc2_].text = _loc16_;
      _loc8_ = _loc4_[_loc3_].split(";")[4];
