...
_loc1.initData = function()
{
   ...
   if(this._oData.challenges && this._oData.challenges.length)
   {
      ...
      while(_loc2_ < this._oData.challenges.length)
      {
         ...
         // Agregar listeners para mostrar tooltip
...
_loc1.over = function(_loc2_)
{
   ...
   else if(_loc2_.target.challenge != undefined && _loc2_.target.challenge.id != undefined)
   {
      // Tooltip para iconos de retos (FightChallengeIcon)
      var c = _loc2_.target.challenge;
      ...
      this.gapi.showTooltip(text, _loc2_.target, -20);
   }
   else
   {
