...
{
   // Initialize all three base colors with valid defaults to avoid sending -1 to server
   this._oColors = {color1:0, color2:0, color3:0};
   this._oBakColors = {color1:0, color2:0, color3:0};
};
