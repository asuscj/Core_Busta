...
_loc1.__get__isTactic = function(oMap)
{
    ...
    if(this.layerGroundNum == 0 && (this.groundSlope == 1 && (this.layerObject2Num == 0 || (this.layerObject2Num == 25 || this.layerObject2Num == 1030))))
    {
      ...
      else if(this.layerObject1Num == dofus.Constants.getTacticGfx(oMap.subarea,1) || this.layerObject1Num == dofus.Constants.getTacticGfx(oMap.subarea,3))
      {
         bIsTactic = true;
      }
   }
...
_loc1.turnTactic = function(mapHandler, oMap)
{
  ...
  else
  {
     ...
     this.tacticType = isEven ? 1 : 3; // Guardar el tipo para diferenciación visual
