...
_loc1.updateStates = function()
{
   ...
   while(_loc2_ <= 9)
   {
      _loc4_ = this["_ldrState" + _loc2_];
      _loc4_.content._mcState.removeMovieClip();
      _loc2_ += 1;
   }
   ...
   if(_loc6_ != undefined)
   {
      ...
      for(var _loc7_ in _loc6_)
      {
         ...
         {
            _loc3_ += 1;
            _loc5_ = this["_ldrState" + _loc3_];
            this.setStateOnLoader(_loc5_,Number(_loc7_));
         }
      }
   }
};
_loc1.initialization = function(_loc2_)
{
   ...
   var _loc4_ = _loc5_.content;
   var _loc3_;
   if(_loc5_ == this._ldrSprite)
   {
...
_loc1.setStateOnLoader = function(_loc2_, _loc3_)
{
   ...
   if(_loc2_.loaded)
   {
      ...
      _loc4_ = "State_" + _loc3_;
      _loc5_ = _loc2_.content.attachMovie(_loc4_,"_mcState",_loc2_.content.getNextHighestDepth());
   }
   else
   {
