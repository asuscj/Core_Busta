   ...
   switch(_loc14_)
   {
      ...
      case "#":
         if(this.api.datacenter.Game.isFight)
         {
            ...
            {
               _loc12_ = "(" + this.api.lang.getText("SPECTATOR") + ")";
            }
            else
            {
      ...
      case "+":
         ...
         break;
      default:
         _loc11_ = _loc3_.charAt(0) == dofus.Constants.EMOTE_CHAR && (_loc3_.charAt(1) == dofus.Constants.EMOTE_CHAR && (_loc3_.charAt(_loc3_.length - 1) == dofus.Constants.EMOTE_CHAR && _loc3_.charAt(_loc3_.length - 2) == dofus.Constants.EMOTE_CHAR));
         ...
         if(_loc11_ && !_global.isNaN(_loc3_.substr(2,_loc3_.length - 4)))
         {
            ...
            _loc17_ = _global.parseInt(_loc3_.substr(2,_loc3_.length - 4));
            _loc15_ = this.api.lang.getSpeakingItemsText(_loc17_ - Number(_loc9_));
            if(_loc15_.m)
            {
               _loc6_ = "MESSAGE_CHAT";
               _loc3_ = _loc15_.m;
