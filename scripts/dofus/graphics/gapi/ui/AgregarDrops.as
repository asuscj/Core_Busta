   ...
   switch(oEvent.target._name)
   {
      ...
      case "_btnModify":
         if(this._lst.selectedItem != undefined)
         {
            ...
            this.api.kernel.DebugConsole.process("ADD_DROP " + _loc2_ + " " + _loc3_ + " " + this._tiPP.text + " " + this._tiPorcentaje.text + " " + this._tiMax.text + " " + this._btnUnico.selected + " " + this._btnRaro.selected);
            this.hideItemViewer(true);
            break;
         }
...
_loc1.itemSelected = function(oEvent)
{
   ...
   switch(oEvent.target)
   {
      ...
      case this._lstMyDrop:
         _loc3_ = this._lstMyDrop.selectedItem;
