...
{
   this._winBackground.title = this.api.datacenter.Player.Name + ", " + this.api.lang.getText("PANEL_LADDERS");
      ...
      default:
         ...
         switch(_loc2_)
         {
            ...
            case this._btnGremio:
               ...
               this._dgMembers.columnsNames = ["#","",this.api.lang.getText("NAME_BIG"),"Miembros",this.api.lang.getText("LEVEL_SMALL"),this.api.lang.getText("EXPERIMENT"),"",""];
               break;
