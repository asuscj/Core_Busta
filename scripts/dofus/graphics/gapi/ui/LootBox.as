...
{
   this.abrircofre.label = this.api.lang.getText("OPEN_BOX");
   this.abrircofreotro.label = this.api.lang.getText("OPEN_OTHER_BOX");
};
_loc1.over = function(oEvent)
{
   switch(oEvent.target)
   {
      case this.abrircofre:
         api = _global.API;
         api.ui.showTooltip(this.api.lang.getText("OPEN_BOX"),oEvent.target,-20,{bXLimit:true,bYLimit:false});
         break;
      case this.abrircofreotro:
         api = _global.API;
         api.ui.showTooltip(this.api.lang.getText("OPEN_OTHER_BOX"),oEvent.target,-20,{bXLimit:true,bYLimit:false});
         break;
      case this._btnCerrar:
         api = _global.API;
         api.ui.showTooltip(this.api.lang.getText("CLOSE"),oEvent.target,-20,{bXLimit:true,bYLimit:false});
   }
};
