...
_global.dofus["\r\x14"].gapi.ui["\r\x1c"].GameResultTeamLight = function ()
{
    super();
};
_global.dofus["\r\x14"].gapi.ui["\r\x1c"].GameResultTeamLight.prototype = new dofus["\r\x14"].gapi.core["\x10\x19"]();
var _loc1 = dofus["\r\x14"].gapi.ui["\r\x1c"].GameResultTeamLight.prototype;
...
_loc1.init = function ()
{
    super.init(false, dofus["\r\x14"].gapi.ui["\r\x1c"].GameResultTeamLight.CLASS_NAME);
};
...
_loc1.initData = function ()
{
    ...
    this._lstPlayers.setSize(undefined, Math.min(_loc2, 1) * this._lstPlayers.rowHeight);
