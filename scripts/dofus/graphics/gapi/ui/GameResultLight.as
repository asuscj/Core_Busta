...
_loc1.initData = function ()
{
    switch (this._oData.fightType)
    {
        case 0:
        {
            var _loc6 = "UI_GameResultTeamLight";
            break;
        } 
        case 1:
        {
            _loc6 = "UI_GameResultTeamLightPVP";
        } 
    } // End of switch
    this.attachMovie(_loc6, "_tCurrentPlayer", 10, {dataProvider: this._oData.currentPlayerInfos});
    if (this._oData.challenges && this._oData.challenges.length)
    {
        this._lblChallenges._y = this._lblBonus._y + 17;
        this._mcChallengesPlacer._y = this._lblBonus._y + 18;
        for (var _loc2 = 0; _loc2 < this._oData.challenges.length; _loc2 = _loc2 + 1)
        {
            var _loc3 = this.attachMovie("FightChallengeIcon", "fci" + _loc2, this.getNextHighestDepth(), {challenge: this._oData.challenges[_loc2], displayUiOnClick: false});
            _loc3._height = _loc0_ = 17;
            _loc3._width = _loc0_;
            _loc3._x = _loc2 * (_loc3._width + 5) + this._mcChallengesPlacer._x - _loc2 * 43;
            _loc3._y = this._mcChallengesPlacer._y;
        } // end of for
    } // end if
};
