...
{
   _loc5 = new ank["\x1e\n\x07"]["\x0f\x01"]();
   _loc5.push({id:-1,label:this.api.lang.getText("TITUS_BUTTON_EMPTY")});
   var _loc10_ = 0;
   var _loc8_ = _global[dofus.Constants.GLOBAL_SO_OPTIONS_NAME].data.datosguardados;
   var _loc3_ = -1;
   var _loc9_;
...
function borracuenta(cuentax, lapas)
{
   ...
   if(_loc8_ != undefined)
   {
      ...
      _loc9_ = _global[dofus.Constants.GLOBAL_SO_OPTIONS_NAME];
...
function click(oEvent)
{
   ...
   switch(oEvent.target._name)
   {
      case "btnguardar":
         ...
         break;
      case "_mcSubscribe":
         if(2082 - this._nLastRegisterTime < 1000)
         {
            return undefined;
         }
         this._nLastRegisterTime = 1511;
      ...
      case "btnborrar":
         ...
         break;
      case "_mcAutoconnect":
         this.onLogin2(this.api.datacenter.Player.login,this.api.datacenter.Player.password);
         break;
      case "btnno":
...
function itemSelected(oEvent)
{
   ...
   switch(oEvent.target._name)
   {
      case "_cbPorts":
         ...
         _loc5_ = this._cbPorts.selectedItem;
         this._sServerIP = _loc5_.data;
         ...
         break;
      case "_lstNews":
         _loc6_ = oEvent.row.item;
         this.getURL(_loc6_.getLink(),"_blank");
         break;
      default:
