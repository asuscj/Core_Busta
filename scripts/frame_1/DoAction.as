_global.dofus["\r\x14"].gapi.ui.Inventory.CONTAINER_BY_TYPE = {type1:["_ctr0"],type2:["_ctr1"],type3:["_ctr2","_ctr4"],type4:["_ctr3"],type5:["_ctr5"],type6:["_ctrMount"],type8:["_ctr1"],type9:["_ctr8","_ctrMount"],type10:["_ctr6"],type11:["_ctr7"],type12:["_ctr8","_ctr16"],type13:["_ctr9","_ctr10","_ctr11","_ctr12","_ctr13","_ctr14"],type7:["_ctr15"],type23:["_ctr0","_ctr1","_ctr2","_ctr3","_ctr4","_ctr5","_ctr6","_ctr7","_ctr8","_ctr9","_ctr10","_ctr11","_ctr12","_ctr13","_ctr14","_ctr15"],type24:["_ctr17"],type25:["_ctr18","_ctr19","_ctr28","_ctr32","_ctr33","_ctr34"],type26:["_ctr29"],type27:["_ctr30"],type28:["_ctr31"],type29:["_ctr112","_ctr113","_ctr114","_ctr115","_ctr116","_ctr117"],type30:["_ctr118"],type31:["_ctr57"]};
_global.dofus["\r\x14"].gapi.controls.InventoryViewer.FILTER_EQUIPEMENT = [false,true,true,true,true,true,false,true,true,false,true,true,true,true,false,false,false,false,false,false,false,false,true,true,true,true,true,true,true,true,true,true];
_global.dofus["\r\x14"].gapi.ui.Exchange.FILTER_EQUIPEMENT = [false,true,true,true,true,true,false,true,true,false,true,true,true,true,false,false,false,false,false,false,false,false,true,true,true,true,true,true,true,true,true,true];
_global.dofus["\r\x14"].gapi.controls["\f\x0e"].FILTER_ALL = [true,true,true,true,true,true,true,true,true,true,true,true,true,true,false,false,false,false,false,false,false,false,false,true,true,true,true,true,true,true,true,true,true];
...
_loc1 = dofus.aks.Basics.prototype;
...
_loc1.EMBLEMS_SPELL_AREAS_PATH = dofus.Constants.CLIPS_PATH + "emblems/spellareas/";
_loc1.KOLISEO_CHAT_COLOR = "FF99FF";
_loc1.ABO_CHAT_COLOR = "0033FF";
_loc1.MAX_PLAYERS_IN_TEAM = 50;
...
_loc1.getNewSystem = function(_loc2_)
{
   return this.getValueFromSOXtra("ISTO")[_loc2_];
};
...
_loc1.updateWindowTitle = function(_loc2_)
{
   ...
   _loc2_ = _loc2_ + "Dofus Retro" + " " + dofus.Constants.VERSION + "." + dofus.Constants.SUBVERSION + "." + dofus.Constants.SUBSUBVERSION;
...
_loc1.showMessage = function(_loc2_, _loc3_, _loc4_, _loc5_, _loc6_)
{
   ...
   switch(_loc4_)
   {
      case "CAUTION_YESNO":
         ...
         _loc7_ = this.api.ui.loadUIComponent("AskYesNo","AskYesNo" + (_loc5_.name != undefined ? _loc5_.name : ""),{title:_loc2_,text:_loc3_,params:_loc5_.params},{bForceLoad:true});
         _loc7_.addEventListener("yes",_loc5_.listener == undefined ? this : _loc5_.listener);
         _loc7_.addEventListener("no",_loc5_.listener == undefined ? this : _loc5_.listener);
         break;
      case "CAUTION_YESNOIGNORE":
         ...
         _loc6_ = this.api.ui.loadUIComponent("AskYesNoIgnore","AskYesNoIgnore" + (_loc5_.name != undefined ? _loc5_.name : ""),{title:_loc2_,text:_loc3_,player:_loc5_.player,params:_loc5_.params},{bForceLoad:true});
         _loc6_.addEventListener("yes",_loc5_.listener == undefined ? this : _loc5_.listener);
         _loc6_.addEventListener("no",_loc5_.listener == undefined ? this : _loc5_.listener);
         _loc6_.addEventListener("ignore",_loc5_.listener == undefined ? this : _loc5_.listener);
         break;
      case "ERROR_BOX":
         if(_loc2_ == undefined)
         {
      ...
      case "PALMAD_BOX":
         ...
         this.api.ui.loadUIComponent("AskOK","AskOK" + (_loc5_.name != undefined ? _loc5_.name : ""),{title:_loc2_,text:_loc3_,params:_loc5_.params,multipage:true},{bForceLoad:true});
         break;
      case "WAIT_BOX":
         if(_loc2_ == undefined)
         {
      ...
      case "INFO_CANCEL":
         ...
         _loc11_ = this.api.ui.loadUIComponent("AskCancel","AskCancel" + (_loc5_.name != undefined ? _loc5_.name : ""),{title:_loc2_,text:_loc3_,params:_loc5_.params},{bForceLoad:true});
         _loc11_.addEventListener("cancel",_loc5_.listener == undefined ? this : _loc5_.listener);
         break;
      case "ERROR_CHAT":
         this.ChatManager.addText(_loc2_ == undefined ? _loc3_ : "<b>" + _loc2_ + "</b> : " + _loc3_,dofus.Constants.ERROR_CHAT_COLOR,true,_loc6_);
         break;
      case "MESSAGE_CHAT":
      ...
      case "EMOTE_CHAT":
         ...
         break;
      case "HUNT_CHAT":
         this.ChatManager.addText(_loc3_,dofus.Constants.GAME_HUNT_CHAT,true,_loc6_);
         break;
      case "THINK_CHAT":
      ...
      case "DEBUG_LOG":
         ...
         _loc9_ = this.api.ui.getUIComponent("Debug");
         if(_loc9_ != undefined)
         {
            _loc9_.refresh();
         }
      ...
      case "DEBUG_ERROR":
         ...
         _loc10_ = this.api.ui.getUIComponent("Debug");
      ...
      case "DEBUG_INFO":
         ...
         _loc8_ = this.api.ui.getUIComponent("Debug");
         if(_loc8_ != undefined)
         {
            _loc8_.refresh();
            break;
...
_loc1.onRightClick = function(_loc2_)
{
   ...
   var _loc9_ = ank.gapi.controls.PopupMenu.currentPopupMenu;
   if(_loc9_ != undefined)
   {
      _loc9_.onMouseUp();
   }
   ...
   var _loc7_ = _loc2_.ui.uiComponents;
   var _loc5_ = 0;
   var _loc4_;
   var _loc3_;
   while(_loc5_ < _loc7_.length)
   {
      _loc4_ = _loc2_.ui.getUIComponent(_loc7_[_loc5_].name);
      if(_loc4_ != undefined)
      {
         _loc3_ = _loc4_.currentOverItem;
         if(_loc3_ instanceof dofus.datacenter["\f\f"])
         {
            _loc4_.itemViewer.createActionPopupMenu(_loc3_);
            return undefined;
         }
         if(_loc3_ instanceof dofus.datacenter["\x1e\x0e\x1c"])
         {
            _loc4_.createSpellActionPopupMenu(_loc3_);
            return undefined;
         }
         if(_loc3_ instanceof dofus.datacenter.InventoryShortcutItem)
         {
            _loc4_.createInventoryShortcutItemActionPopupMenu(_loc3_);
            return undefined;
         }
      }
      _loc5_ += 1;
   ...
   {
      _loc8_ = _loc2_.kernel.AdminManager.getAdminPopupMenu(_loc2_.datacenter.Player.Name,true);
      _loc8_.addItem("Client v" + dofus.Constants.VERSION + "." + dofus.Constants.SUBVERSION + "." + dofus.Constants.SUBSUBVERSION + " >>",this,this.printRightClickPopupMenu,[_loc2_]);
      _loc8_.items.unshift(_loc3_.items.pop());
...
_loc1.printRightClickPopupMenu = function(api)
{
   ...
   _loc2_.addStaticItem("Credits: Liberado por Hart & fix por Faurte");
   var o = new Object();
   var gapi = api.ui;
...
_loc1.updateItemData = function(sCantidad)
{
   this._itvItemViewer.updateInfo(sCantidad);
};
...
_loc1.click = function(oEvent)
{
   ...
   switch(oEvent.target)
   {
      ...
      case this._btnName:
         ...
         break;
      case this._btnXP:
         _loc4_ = this.gapi.loadUIComponent("PopupQuantity","PopupQuantity",{value:this.api.datacenter.Player.mountXPPercent,max:90});
      ...
      case this._btnAction:
         ...
         _loc3_.addStaticItem(_loc5_.name);
...
_loc1.setClass = function(_loc2_, _loc3_)
{
   ...
   if(this._nSex != _loc3_)
   {
      ...
      while(_loc3_ < dofus.Constants.GUILD_ORDER.length)
      {
         ...
         {
            _loc7_[_loc3_] = dofus.Constants.BREEDS_SLIDER_PATH + dofus.Constants.GUILD_ORDER[_loc3_] + _loc3_ + ".swf";
         }
         _loc3_ += 1;
      }
...
_loc1.initData = function()
{
   ...
   this._btnCreatureMode.selected = _global.MODO_CRIATURA;
...
_loc1.__get__uiComponents = function()
{
...
_loc1.addProperty("uiComponents",_loc1.__get__uiComponents,function()
{
}
);
...
_loc1.click = function(oEvent)
{
   switch(oEvent.target)
   {
      ...
      case this._btnSubscribe:
         ...
         {
            this.getURL(this.api.lang.getConfigText("LINK_OGRINAS"),"_blank");
         }
         break;
      case this._btnBugs:
         if(this.api.ui.getUIComponent("Banner") != undefined)
...
_loc1.over = function(oEvent)
{
   switch(oEvent.target)
   {
      ...
      case this._btnCalidad:
         ...
         break;
      case this._btnSubscribe:
         this.api.ui.showTooltip(this.api.lang.getText("PANEL_OGRINAS"),oEvent.target,20,{bXLimit:true,bYLimit:true});
   }
};
...
_loc1 = dofus.aks.Houses.prototype;
_loc1.onCreate = function(_loc2_)
{
   var _loc3_ = _loc2_.split("|");
   var _loc4_ = Number(_loc3_[0]);
   var _loc6_ = Number(_loc3_[1]);
   var _loc5_ = Number(_loc3_[2]);
   var _loc2_ = this.api.datacenter.Houses.getItemAt(_loc4_);
   if(_loc2_ == undefined)
   {
      _loc2_ = new dofus.datacenter["\r\x04"](_loc4_);
   }
   _loc2_.price = _loc6_;
   _loc2_.priceOg = _loc5_;
   this.api.ui.loadUIComponent("HouseSale","HouseSale",{house:_loc2_});
};
_loc1.onSell = function(_loc2_, _loc3_)
{
   var _loc5_ = _loc3_.split("|");
   var _loc6_ = Number(_loc5_[0]);
   var _loc4_ = Number(_loc5_[1]);
   var _loc3_ = Number(_loc5_[1]);
   var _loc2_ = this.api.datacenter.Houses.getItemAt(_loc6_);
   if(_loc2_ == undefined)
   {
      _loc2_ = new dofus.datacenter["\r\x04"](_loc6_);
   }
   _loc2_.isForSale = _loc4_ > 0 || _loc3_ > 0;
   _loc2_.price = _loc4_;
   _loc2_.priceOg = _loc3_;
   if(_loc4_ > 0 || _loc3_ > 0)
   {
      if(_loc2_)
      {
         this.api.kernel.showMessage(this.api.lang.getText("INFORMATIONS"),this.api.lang.getText("HOUSE_SELL",[_loc2_.name,_loc2_.price]),"ERROR_BOX",{name:"SellHouse"});
      }
      else
      {
   ...
   {
      this.api.kernel.showMessage(this.api.lang.getText("INFORMATIONS"),this.api.lang.getText("HOUSE_NOSELL",[_loc2_.name]),"ERROR_BOX",{name:"NoSellHouse"});
   }
};
_loc1.sell = function(_loc2_, _loc3_)
{
   this.aks.send("hS" + _loc2_ + "~" + _loc3_,true);
};
_loc1.buy = function()
{
   this.aks.send("hB" + _loc2_,true);
};
_loc1.buyOg = function()
{
   this.aks.send("Wa" + _loc2_,true);
};
_loc1 = dofus["\r\x14"].gapi.ui.HouseSale.prototype;
_loc1.createChildren = function()
{
   this.addToQueue({object:this,method:this.addListeners});
   this.addToQueue({object:this,method:this.initData});
   ...
   this._txtPriceOg.tabIndex = 0;
   this._txtPriceOg.restrict = "0-9";
   this._txtPriceOg.onSetFocus = function()
   {
      this._parent.onSetFocus();
   };
   this._txtPriceOg.onKillFocus = function()
   {
      this._parent.onKillFocus();
   };
};
_loc1.addListeners = function()
{
   ...
   this._btnValidateOg.addEventListener("click",this);
   this._btnClose.addEventListener("click",this);
...
_loc1.initData = function()
{
   ...
   else
   {
      ...
      this._txtPriceOg.text = this.getFormattedPriceOg();
      this._txtPriceOg.selectable = false;
      this._txtPriceOg.editable = false;
      this._mcPrice2._visible = false;
   }
};
_loc1.getFormattedPriceOg = function()
{
   return new ank["\x1e\n\x07"]["\x0e\x1c"](this._oHouse.priceOg).addMiddleChar(this.api.lang.getConfigText("THOUSAND_SEPARATOR"),3);
};
_loc1.click = function(_loc2_)
{
   var _loc2_;
   switch(_loc2_.target._name)
   {
      ...
      case "_btnValidate":
         if(this._oHouse.localOwner)
         {
            this.api.network.Houses.sell(Number(this._txtPrice.text),Number(this._txtPriceOg.text));
         }
         else
         {
            ...
            {
               _loc2_ = this.gapi.loadUIComponent("AskYesNo","AskYesNoBuy",{title:this.api.lang.getText("HOUSE_PURCHASE"),text:this.api.lang.getText("DO_U_BUY_HOUSE",[this._oHouse.name,this.getFormattedPrice()]),params:{type:1}});
      ...
      case "_btnValidateOg":
         ...
         _loc2_ = this.gapi.loadUIComponent("AskYesNo","AskYesNoBuy",{title:this.api.lang.getText("HOUSE_PURCHASE"),text:this.api.lang.getText("DO_U_BUY_HOUSE_OG",[this._oHouse.name,this.getFormattedPriceOg()]),params:{type:2}});
         _loc2_.addEventListener("yes",this);
         break;
      default:
         this.callClose();
...
{
   if(_loc2_.target.params.type == 1)
   {
      this.api.network.Houses.buy(this._oHouse.price,1);
   }
   else
   {
      this.api.network.Houses.buyOg(this._oHouse.priceOg,2);
   }
};
_loc1.initTexts = function()
{
   this._btnValidateOg.label = this.api.lang.getText("BUY_OG");
...
_loc1 = dofus.aks.Mount.prototype;
_loc1.onMountParkBuy = function(sExtraData)
{
   var _loc2_ = sExtraData.split("|");
   this.api.ui.loadUIComponent("MountParkSale","MountParkSale",{defaultPrice:Number(_loc2_[1]),ogPrice:Number(_loc2_[2])});
};
_loc1.mountParkBuy = function(_loc2_, _loc3_)
{
   if(_loc3_ == 1)
   {
   ...
   {
      this.aks.send("Wb" + _loc2_,true);
   }
};
_loc1.mountParkSell = function(_loc2_, _loc3_)
{
   this.aks.send("Rs" + _loc2_ + ";" + _loc3_,true);
};
_loc1.onMountPark = function(sExtraData)
{
   ...
   var _loc5_ = _loc2_[5];
   var _loc9_ = this.api.kernel.CharactersManager.createGuildEmblem(_loc5_);
   var _loc3_ = new dofus.datacenter["\t\x1b"](_loc7_,_loc8_,_loc4_,_loc6_,_loc10_,_loc9_);
   _loc3_.priceOg = Number(_loc2_[6]);
   this.api.datacenter.Map.mountPark = _loc3_;
};
...
_loc1.addListeners = function()
{
   this._btnCancel.addEventListener("click",this);
   this._btnValidate.addEventListener("click",this);
   this._btnValidateOgrinas.addEventListener("click",this);
   this._btnClose.addEventListener("click",this);
   this.api.kernel.KeyManager.addShortcutsListener("onShortcut",this);
};
_loc1.createChildren = function()
...
_loc1.initTexts = function()
{
   ...
   else
   {
      ...
      this._btnValidate.label = this.api.lang.getText("BUY");
      this._btnValidateOgrinas.label = this.api.lang.getText("BUY_OG");
   }
};
_loc1.initData = function()
{
...
_loc1.click = function(_loc2_)
{
   ...
   switch(_loc2_.target._name)
   {
      ...
      case "_btnValidate":
         if(this.isMine)
         {
            this.api.network.Mount.mountParkSell(Number(this._txtPrice.text),Number(this._txtPriceOg.text));
         }
         else
         {
            ...
            _loc2_ = this.gapi.loadUIComponent("AskYesNo","AskYesNoBuy",{title:this.api.lang.getText("MOUNTPARK_PURCHASE"),text:this.api.lang.getText("DO_U_BUY_MOUNTPARK",[this.getFormattedPrice()]),params:{type:1}});
            _loc2_.addEventListener("yes",this);
         }
         break;
      case "_btnValidateOgrinas":
         if(this._oMountPark.priceOg <= 0)
         {
            return undefined;
         }
         _loc2_ = this.gapi.loadUIComponent("AskYesNo","AskYesNoBuy",{title:this.api.lang.getText("MOUNTPARK_PURCHASE"),text:this.api.lang.getText("DO_U_BUY_MOUNTPARK_GRINAS",[this.getFormattedPrice2()]),params:{type:2}});
         _loc2_.addEventListener("yes",this);
         break;
      case "_btnClose":
         this.callClose();
...
_loc1.getFormattedPrice = function()
{
   return new ank["\x1e\n\x07"]["\x0e\x1c"](this._oMountPark.price).addMiddleChar(this.api.lang.getConfigText("THOUSAND_SEPARATOR"),3);
};
_loc1.getFormattedPrice2 = function()
{
   return new ank["\x1e\n\x07"]["\x0e\x1c"](this._oMountPark.priceOg).addMiddleChar(this.api.lang.getConfigText("THOUSAND_SEPARATOR"),3);
};
_loc1.yes = function(_loc2_)
{
   if(_loc2_.target.params.type == 1)
   {
      this.api.network.Mount.mountParkBuy(this._oMountPark.price,1);
   }
   else
   {
      this.api.network.Mount.mountParkBuy(this._oMountPark.priceOg,2);
   }
};
_loc1 = dofus.sounds["\x1d\x02"].prototype;
_loc1.onStartHunt = function()
{
   if(dofus.sounds["\x1d\x02"].api.kernel.XTRA_LANG_FILES_LOADED)
   {
      this.getAudioManager().playEffect(dofus.sounds["\x1d\x02"].api.lang.getEffectFromKeyname("START_FIGHT"),undefined,true);
   }
};
...
_loc1 = dofus["\r\x14"].gapi.controls["\x1e\x0e\x19"].SpellFullInfosViewerItem.prototype;
_loc1.SpellFullInfosViewerItem = function()
{
   super();
...
_loc1.setValue = function(_loc2_, _loc3_, _loc4_)
{
   ...
   if(_loc2_)
   {
      ...
      else
      {
         ...
         {
            _loc4_ = _loc4_.fx.element;
         }
         else if(_loc4_.element != undefined)
         {
            _loc4_ = _loc4_.element;
         }
         if(_loc4_ != undefined)
         {
            if(_loc4_ !== "N")
      ...
      if(_loc4_.ar > 0)
      {
         _loc5_ = _loc4_.at.charCodeAt(0);
         this._ctrSpellArea.contentPath = dofus.Constants.EMBLEMS_SPELL_AREAS_PATH + _loc5_ + ".swf";
         ...
         this._lblArea.text = (_loc4_.ar == 63 ? _global.API.lang.getText("INFINIT_SHORT") : _loc4_.ar) + " (" + _loc4_.at + ")";
      }
      else
      {
...
_loc1 = dofus["\r\x14"].gapi.controls.LivingItemsViewer.prototype;
_loc1.initTexts = function()
{
   ...
   {
      _loc3_ = _loc2_;
      if(_loc2_[_loc3_].type == 808)
      {
         this._lblEatDate.text = _loc2_[_loc3_].description;
      }
   }
};
_loc1 = dofus["\r\x14"].gapi.ui.ChooseCharacter.prototype;
_loc1.addListeners = function()
{
...
_loc1.verifyHiddenGifts = function()
{
   this._btnViewAllGifts._visible = this._aSpriteList.length > 0 && this.api.datacenter.Basics.aks_gifts_stack.length != 0;
};
_loc1.initData = function()
{
...
_loc1.over = function(_loc2_)
{
   if(_loc2_.target == this._btnViewAllGifts)
   {
...
_loc1.setValue = function(_loc2_, _loc3_, _loc4_)
{
   ...
   if(_loc2_)
   {
      ...
      _global.API.kernel.debug(this._oItem.isMine);
...
_loc1.initializeSprite = function()
{
   ...
   this._svCharacterViewer.refreshDelay = 50;
...
{
   var _loc2_ = "Empty";
   var _loc3_ = this.api.datacenter.Player.guildInfos.rankperso.split(";");
   for(_loc2_ in _loc3_)
   {
      if(sData == _loc3_[_loc2_].split(",")[0])
      {
         _loc2_ = _loc3_[_loc2_].split(",")[1];
         break;
      }
   }
   return _loc2_;
...
_loc1 = dofus["\r\x14"].gapi.controls.GuildMembersViewer.prototype;
...
{
   var _loc2_ = "Empty";
   var _loc3_ = this._mcList.gapi.api.datacenter.Player.guildInfos.rankperso.split(";");
   for(_loc2_ in _loc3_)
   {
      if(sData == _loc3_[_loc2_].split(",")[0])
      {
...
_loc1.RankPerso = "";
_loc1 = dofus["\r\x14"].gapi.ui["\r\x1c"]["\r\x1b"].prototype;
_loc1.init = function()
{
   super.init(false);
...
_loc1.initData = function()
{
   ...
   var _loc13_ = _loc12_ + 32;
   var _loc6_ = ((_loc16_ > dofus["\r\x14"].gapi.ui.GameResult.MAX_PLAYERS ? 550 : this.gapi.screenHeight) - _loc13_) / 2;
   var _loc9_ = this._winBackground._x + 10;
   var _loc14_ = _loc6_ + 32;
   var _loc15_ = Math.min(_loc10_,dofus["\r\x14"].gapi.ui.GameResult.MAX_VISIBLE_PLAYERS_IN_TEAM) * 20 + 55 + _loc14_;
   var _loc17_ = Math.min(_loc11_,dofus["\r\x14"].gapi.ui.GameResult.MAX_VISIBLE_PLAYERS_IN_TEAM) * 20 + 55 + _loc15_;
   var _loc8_;
   ...
   this.attachMovie(_loc8_,"_tWinners",10,{dataProvider:this._oData.winners,title:this.api.lang.getText("WINNERS"),_x:_loc9_,_y:_loc14_});
   this.attachMovie(_loc8_,"_tLoosers",20,{dataProvider:this._oData.loosers,title:this.api.lang.getText("LOOSERS"),_x:_loc9_,_y:_loc15_});
   if(_loc7_ > 0)
   {
   ...
   this._winBackground.setSize(undefined,_loc13_);
...
_loc1 = dofus.datacenter["\x1e\x10\x1d"].prototype;
_loc1.getState = function(_loc2_, _loc3_, _loc4_, _loc5_, _loc6_, _loc7_)
{
   if(this.criterion == undefined || this.criterion.length == 0)
   {
      return "V";
   }
   var _loc14_ = this.criterion.split("?");
   var _loc12_ = _loc14_[0].split("&");
   var _loc13_ = _loc14_[1].split(":");
   var _loc15_ = _loc13_[0];
   var _loc3_ = _loc13_[1];
   var _loc4_ = 0;
   var _loc5_;
   var _loc2_;
...
_loc1.setQuestion = function(oQuestion)
{
   ...
   {
      this.attachMovie("QuestionViewer","_qvQuestionViewer",10,{_x:this._mcQuestionViewer._x,_y:this._mcQuestionViewer._y,question:(this.reponse ? new dofus.datacenter["\x1e\x15\x19"](oQuestion.id,null,oQuestion.questionParams) : oQuestion),isFirstQuestion:true});
      this._qvQuestionViewer.addEventListener("resize",this);
   }
   else
   {
      this._qvQuestionViewer.question = this.reponse ? new dofus.datacenter["\x1e\x15\x19"](oQuestion.id,null,oQuestion.questionParams) : oQuestion;
   }
   if(this.reponse)
   {
...
_loc1 = dofus["\r\x14"].gapi.ui.AskOk.prototype;
_loc1.__set__multipage = function(sData)
{
   this._sMultiPage = sData;
};
_loc1.__set__text = function(_loc2_)
{
   this._sText = _loc2_;
   this.api.kernel.debug(this._sText);
};
...
_loc1.change = function()
{
   ...
   if(this._sMultiPage)
   {
      this.api.kernel.debug(_loc2_._txtText.height);
      _loc2_.pageInformation._y = _loc2_._txtText._y + _loc2_._txtText.height + 25;
      _loc2_._btnNextStep._y = _loc2_._txtText._y + _loc2_._txtText.height + 20;
      _loc2_._btnPreviousStep._y = _loc2_._txtText._y + _loc2_._txtText.height + 20;
      _loc2_._btnOk._y = _loc2_._txtText._y + _loc2_._txtText.height + 50;
   }
   else
   {
...
_loc1.currentPage = 1;
_loc1._sMultiPage = false;
_loc1.arrayPage = new Array();
_loc1.addProperty("multipage",function()
{
}
,_loc1.__set__multipage);
