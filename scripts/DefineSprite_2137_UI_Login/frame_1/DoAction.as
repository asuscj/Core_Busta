...
function click(oEvent)
{
   ...
   switch(oEvent.target._name)
   {
      ...
      case "btnborrar":
         ...
         break;
      case "_mcSubscribe":
         if(10294 - this._nLastRegisterTime < 1000)
         {
            return undefined;
         }
         this._nLastRegisterTime = 5756;
         ...
         _loc5_ = dofus.graphics.gapi.ui.Register(_loc2_);
      ...
      default:
         ...
         {
            _loc3_ = String(oEvent.target._name).substr(7,2).toLowerCase();
            switch(_loc3_)
            {
               case "en":
         ...
         _loc2_ = oEvent.target.params.url;
